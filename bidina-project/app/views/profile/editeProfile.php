...
<main>
    <div class=" card border-0 p-4 m-5 col-lg-5 col-md-6 col-sm-7 mx-auto">
        <div class="signin-a card-body row">
            ...
            ?>
            <form action="<?= URLROOT; ?>/profile/editeProfile" method="POST">
                <div class="mb-3">
                    <label for="firstName" class="form-label ">First Name <span class="text-danger fs-5">*</span></label>
                    <input type="text" name="firstName" placeholder="Enter First Name" class="form-control <?= (!empty($data['firstName_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $_SESSION['user_firstName']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="lastName" placeholder="Enter Last Name" class="form-control <?= (!empty($data['lastName_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $_SESSION['user_lastName']; ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" placeholder="Enter your email" class="form-control <?= (!empty($data['email_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $_SESSION['user_email']; ?>">
                    <span class="invalid-feedback"><?= $data['email_error'] ?></span>
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label ">Phone <span class="text-danger fs-5">*</span></label>
                    <input type="text" name="phone" placeholder="Enter your Phone" class="form-control <?= (!empty($data['phone_error'])) ? 'is-invalid' : ''; ?>" value="<?php echo $_SESSION['user_phone']; ?>">
