    ...
    <header>
        <!-- <div class="into d-lg-flex justify-content-between align-items-center p-2 px-5 d-none">
            ...
            <div class="select">
                <select class="form-select selectA" aria-label="Default select example">
                        ...
                        <div class="col p-lg-0 w-100">
                            <ul class="items p-3 d-flex align-lg-items-center justify-content-start justify-content-lg-center flex-column flex-lg-row list-unstyled">
                                ...
                                <div class="fs-6 shop_button nav-item">Shop <i class="fas fa-angle-down ps-2 fs-5" style="top: 10px;"></i>
                                    <div class="bg-shop-down navbar-a p-3 ">
                                        <ul class=" shop_down  list-unstyled">
                                            <li><a class="dropdown-item px-2 py-2 shop-item" href="#">Shop 3 Column</a></li>
                                            <li><a class="dropdown-item px-2 py-2 shop-item" href="#">Shop 4 Column</a></li>
                                            <li><a class="dropdown-item px-2 py-2 shop-item" href="#">Shop Left Sidebar</a></li>
                                        </ul>
                                    </div>
                                </div>
                                </li>
